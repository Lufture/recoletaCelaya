              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Busca tu dirección para recibir alertas precisas sobre tu ruta de recolección.',
          ...
          FlutterMap(
            ...
            options: MapOptions(
              ...
              onTap: (tapPosition, point) {
                // Opcional: permitir seleccionar punto tocando el mapa
                setState(() {
  ...
  Widget _buildConfirmButton(BuildContext context) {
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        label: Text(
          _isLoading ? 'Guardando...' : 'Confirmar domicilio',
          style: GoogleFonts.poppins(
        ...
        onPressed: _isLoading ? null : () async {
          ...
          if (_selectedTag == null) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Por favor selecciona una etiqueta para tu domicilio (ej. Mi Casa)')),
            );
            return;
          }
          ...
          try {
            ...
            if (user != null) {
              await Supabase.instance.client.from('domicilios_usuario').insert({
                'usuario_id': user.id,
                'alias': _selectedTag,
